            ...
            <div className="relative z-10 h-full flex flex-col justify-center p-8 sm:p-12 text-white">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <span className="text-white/80">Publish your thoughts and ideas</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-green-400 rounded-full mr-3"></div>
                  <span className="text-white/80">Connect with readers worldwide</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-green-400 rounded-full mr-3"></div>
                  <span className="text-white/80">Grow your audience and impact</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl border ${role === "reader" ? "border-green-500 bg-green-50 text-green-700" : "border-gray-300 bg-white text-gray-700"} focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors flex items-center justify-center`}
                    >
                    ...
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl border ${role === "creator" ? "border-green-500 bg-green-50 text-green-700" : "border-gray-300 bg-white text-gray-700"} focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors flex items-center justify-center`}
                    >
